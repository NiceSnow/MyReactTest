    ...
    if (this.state.loadStatus == LoadMoreStatus.noMoreData){
      return(
        <View>
          <View style={footStyles.footer}>
            <GQCustomText style={footStyles.footerText}>{this.props.noMoreDataTitle}</GQCustomText>
          </View>
          {this.props.renderFooter?this.props.renderFooter():null}
        </View>
      ...
      return(
        <View>
          <View style={footStyles.footer}>
            {/*<ActivityIndicator/>*/}
            <GQCustomText style={footStyles.footerText}>{this.props.pusuToLoadMoreTitle}</GQCustomText>
          </View>
          {this.props.renderFooter?this.props.renderFooter():null}
        </View>
      )
      ...
      return(
        <View>
          <View style={footStyles.footer}>
            <ActivityIndicator/>
            <GQCustomText style={footStyles.footerText}>{this.props.loadingTitle}</GQCustomText>
          </View>
          {this.props.renderFooter?this.props.renderFooter():null}
        </View>
      )
    ...
    return(
      <View style={defaultHeaderStyles.background}>
        <View style={defaultHeaderStyles.status}>
          ...
          <GQCustomText style={defaultHeaderStyles.statusTitle}>{this.state.refreshTitle}</GQCustomText>
        </View>
        <GQCustomText style={defaultHeaderStyles.date}>{'上次更新时间:'+this.state.date}</GQCustomText>
      </View>
    )
  }
